...
yScale.domain([0,d3.max(data,function(d){return d.purchasingPower;})]);
...
.attr({
  ...
  'y':function(d){return yScale(d.purchasingPower);},
  "width":xScale.rangeBand(),
  "height":function(d){return height - yScale(d.purchasingPower);}
})
...
.enter()
.append('text')
.text(function(d){return d.purchasingPower;})
.attr('x',function(d){return xScale(d.country) + xScale.rangeBand()/2;})
.attr('y',function(d){return yScale(d.purchasingPower)+12;})
.style("fill","white")
